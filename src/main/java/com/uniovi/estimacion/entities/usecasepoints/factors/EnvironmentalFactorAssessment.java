package com.uniovi.estimacion.entities.usecasepoints.factors;
...
public class EnvironmentalFactorAssessment {
    ...
    private EnvironmentalFactorType factorType;
